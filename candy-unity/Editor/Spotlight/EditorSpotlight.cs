                    ...
                    else
                    {
                        if (0 != start)
                            coloredAssetName.Append(
                                string.Format("<color=#{0}>{1}</color>", normalColor, assetName.Substring(0, start))
                            );
        ...
        *************************************************************************************************/
        private static class Styles
        {
            ...
            static Styles()
            {
                ...
                inputFieldStyle.normal.textColor = EditorGUIUtility.isProSkin
                    ? new Color(1, 1, 1, .8f)
                    : new Color(.2f, .2f, .2f, .8f);
                inputFieldStyle.focused.textColor = EditorGUIUtility.isProSkin
                    ? new Color(1, 1, 1, .8f)
                    : new Color(.2f, .2f, .2f, .8f);
