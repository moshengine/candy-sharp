...
namespace MoshEngine.Candy.Unity.Editor
{
    ...
    public class ModelToPrefabConverterWindow : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            _configScriptTemplate =
                EditorGUILayout.ObjectField("Config Script Template", _configScriptTemplate, typeof(TextAsset), false)
                as TextAsset;
            _controllerScriptTemplate =
            ...
            _stateScriptTemplate =
                EditorGUILayout.ObjectField("State Script Template", _stateScriptTemplate, typeof(TextAsset), false)
                as TextAsset;
            _viewScriptTemplate =
                EditorGUILayout.ObjectField("View Script Template", _viewScriptTemplate, typeof(TextAsset), false)
                as TextAsset;
            EndSection();

            BeginSection("Current");
            _selectedModel =
                EditorGUILayout.ObjectField("Select Model", _selectedModel, typeof(GameObject), false) as GameObject;
