     ...
     *************************************************************************************************/
     private static class Styles
     {
          ...
          static Styles()
          {
               ...
               inputFieldStyle.normal.textColor = EditorGUIUtility.isProSkin ? new Color(1, 1, 1, .8f) : new Color(.2f, .2f, .2f, .8f);
               inputFieldStyle.focused.textColor = EditorGUIUtility.isProSkin ? new Color(1, 1, 1, .8f) : new Color(.2f, .2f, .2f, .8f);
